function [patches, patchCenters] = extractPatches(image, patchDim)
    ...
    % zelimo pridruziti kvadratni patch dimenzije patchDim ciji je taj piksel centra

    % zbog svih piksela udaljneih od ruba slike za manje od patchDim/2
    ...
    for c_center = 1 : W
        for r_center = 1 : H
            % istovrmeno pridruzujemo pripadni gornji lijevi vrh - on je iz paddedImage
            top = r_center;
            left = c_center;
    
            % izdvajanje prirpadnog patch-a iz paddedImage
